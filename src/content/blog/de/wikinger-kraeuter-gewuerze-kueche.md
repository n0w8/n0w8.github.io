...
heroImageAlt: "Reife blaue Wacholderbeeren an einem Zweig vor unscharfem Waldhintergrund"
readingTime: 7
...
Noch ein Punkt: Küche und Heilkunde waren im Norden nicht sauber getrennt. Dieselben Pflanzen, die im Topf landeten, dienten auch als Hausmittel. Das war keine Magie, sondern der normale Umgang mit dem, was vor der Tür wuchs. Den größeren Zusammenhang findest du in unserem Überblick zur [Ernährung der Wikinger](/blog/wikinger-ernaehrung-essen).

![Blühender Dill mit gelben Blütendolden](/images/viking-herbs-2.jpg)

*Bildquelle: Bff (CC BY-SA 3.0), via Wikimedia Commons*

| Kraut/Gewürz | im Norden belegt als | Geschmack | so setzt du es heute ein |
|---|---|---|---|
| Dill | Pflanzen- und Samenreste aus Siedlungsschichten | frisch, leicht anisartig | Fisch, Kräutersalz, Sauerrahm |
| Senf | Samenfunde in Siedlungskontexten | scharf, beim Rösten nussig | Kräutersalz, Beize, Braten |
| Meerrettich | Pflanzenreste aus nordischen Fundschichten | brennende Schärfe, süßlicher Nachklang | frisch gerieben zu Fisch und Rind |
| Kümmel | Samenfunde, unter anderem in der Oseberg-Bestattung | erdig, warm | Kohl, Brot, Käse, Kräutersalz |
| Wacholder | Beeren und Holz an nordischen Fundplätzen | harzig, waldig, leicht bitter | Wild, Sauerkraut, Kräutersalz |
| Koriander | Samenfunde in Siedlungs- und Handelsplatzschichten | zitrusartig, warm | Kräutersalz, Brot, Wurzelgemüse |
| Beifuß | Wildpflanze, Reste an Siedlungsplätzen | herb bis bitter, stark aromatisch | sehr sparsam zu fettem Braten |
| Bärlauch | Wildpflanze, Reste in Siedlungskontexten | knoblauchartig, mild | Butter, Quark, Frühlingssalz |
| Kresse | Samen in der Oseberg-Bestattung | scharf, pfeffrig | frisch über Ei, Brot und Suppe |
...
Für ein ehrliches Nord-Aroma brauchst du diese Importe gar nicht. Wacholder, Dill, Senf und Kümmel tragen ein Gericht vollkommen allein - und sie passen hervorragend zu einem warmen [Wikinger-Fladenbrot](/blog/wikinger-fladenbrot-rezept) aus der Pfanne.
...
Wenn dir dieses Rezept Lust auf mehr nordische Küche gemacht hat: Es stammt aus derselben Werkstatt wie unsere Sammlung. Im Kochbuch **"Wikinger Festmahl - Das große Wikinger-Kochbuch"** stehen 141 Rezepte, vom Eintopf über Brot und Braten bis zu den passenden Getränken. [Zum Kochbuch](/kochbuch)
...
<script type="application/ld+json">
{
  ...
  "@type": "Recipe",
  "name": "Nordisches Kräutersalz mit Wacholder und Dill",
  ...
  "cookTime": "PT10M",
  "totalTime": "PT30M",
  "recipeYield": "ca. 125 g Kräutersalz (1 Glas)",
  "recipeCategory": "Gewürzmischung",
  "recipeCuisine": "Nordisch",
  "keywords": "wikinger kräuter gewürze küche, nordisches kräutersalz, wacholder dill salz, kräuterbutter wacholder",
  "recipeIngredient": [
    "100 g grobes Meersalz",
    "2 EL getrocknete Dillspitzen (etwa 6 g)",
    "1 EL Wacholderbeeren (etwa 8 g, rund 15 Beeren)",
    ...
    "1 kleine Prise getrockneter Beifuß (optional)"
  ],
  "recipeInstructions": [
    { "@type": "HowToStep", "name": "Samen rösten", "text": "Wacholderbeeren, Kümmel, Senfkörner und Koriandersamen ohne Fett bei mittlerer Hitze 1 bis 2 Minuten rösten, bis es duftet, dann auf einem kalten Teller auskühlen lassen." },
    { "@type": "HowToStep", "name": "Wacholder anstoßen", "text": "Die Wacholderbeeren im Mörser nur grob anstoßen, nicht pulverisieren." },
    { "@type": "HowToStep", "name": "Mit dem Salz mörsern", "text": "Alle gerösteten Samen zusammen mit dem groben Meersalz im Mörser zerstoßen, bis eine sichtbar körnige Mischung entsteht." },
    { "@type": "HowToStep", "name": "Kräuter unterheben", "text": "Getrockneten Dill, Bärlauch und Beifuß mit einem Löffel unterheben, nicht mitmörsern." },
    { "@type": "HowToStep", "name": "Nachtrocknen", "text": "Die Mischung dünn auf einem Backblech verteilen und bei 50 Grad Celsius etwa 10 Minuten nachtrocknen, die Ofentür einen Spalt offen lassen, danach vollständig abkühlen lassen." },
    { "@type": "HowToStep", "name": "Abfüllen", "text": "Das kalte Kräutersalz in ein trockenes Schraubglas füllen, verschließen und kühl und dunkel lagern. Aromatisch bleibt es etwa sechs Monate." }
  ]
}
</script>
